...
<body id="page-top">
	...
	<?php require_once '_sidebar.php'; ?>
						...
						<div class="card-body">
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									...
									<div class="h5 mb-0 font-weight-bold text-gray-800">KELAS AMAN - XI RPL 3</div>
								</div>
								<div class="col-auto">
						...
						<div class="card-body">
							<div class="row no-gutters align-items-center">
								<div class="col mr-2">
									...
									<div class="h5 mb-0 font-weight-bold text-gray-800">Mujahaddah</div>
								</div>
								<div class="col-auto">
			...
			<div class="row">
				<div class="col">
					<div class="card shadow">
						<div class="card-header">Data Kelas - XI RPL 3</div>
						<div class="card-body">
							<form action="proses_ubah.php" method="POST">
								<div class="form-group">
									<label for="nama_kelas">Nama Kelas </label>
									<input type="text" name="nama_kelas" class="form-control" autocomplete="off" required="required" value="Kelas Aman RPL 3">
								</div>
								<div class="form-group">
									<label for="wali_kelas">Wali Kelas </label>
									<input type="text" name="wali_kelas" class="form-control" autocomplete="off" required="required" value="Mujahaddah">
								</div>
								<div class="form-group">
									<label for="sekolah">Sekolah </label>
									<input type="text" name="sekolah" class="form-control" autocomplete="off" required="required" value="SMK UFA">
								</div>
								<div class="form-group">
									<label for="alamat_sekolah">Alamat Sekolah </label>
									<input type="text" name="alamat_sekolah" class="form-control" autocomplete="off" required="required" value="Rembang">
								</div>
								<div class="form-group">
									<label for="tahun_ajaran">Tahun Ajaran </label>
									<input type="text" name="tahun_ajaran" class="form-control" autocomplete="off" required="required" value="2019/2020">
								</div>
								<div class="form-group">
									<label for="semester">Semester </label>
									<input type="text" name="semester" class="form-control" autocomplete="off" required="required" value="Genap">
								</div>
								<div class="form-group">
		...
		<span>Copyright &copy; Safitri</span>
		</div>
		</div>
		</footer>
		<!-- End of Footer -->
